...
HD_PWD='D:/Digital Alarm/Digital_Alarm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Alarm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Digital_Alarm.tcl -notrace
