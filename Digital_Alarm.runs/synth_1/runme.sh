...
HD_PWD='D:/Digital Alarm/Digital_Alarm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Alarm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digital_Alarm.tcl
